...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $total_test = Test::get()->count();
      	...
      	// Expense & Profit
        $expenses = Expense::whereDate('date', '=', date('Y-m-d'))->get();
        $total_expense = $expenses->sum('amount');
        $profit = $total['total_amount'] - $total_expense;

    	return view('dashboard' , compact('invoices', 'total' ,'appointments','patients' , 'pending' , 'opds', 'total_doctor', 'total_test', 'total_expense', 'profit'));
