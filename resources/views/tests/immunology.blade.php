...
<div class="col-md-4" style="display: none" id="edit_test_reference">
    ...
    @csrf
				      	<div class="form-group">
						    <label>Name:</label>
					 	    <input type="text" name="name" class="form-control" id="test_reference_name" required>
					    </div>
			    		<div class="form-group">
			    			<label>Unit:</label>
			    			<input type="text" name="unit" class="form-control" id="test_reference_unit">
			    		</div>
			    		<div class="form-group">
			    			<label>Ref Range:</label>
			    			<input type="text" name="range" class="form-control" id="test_reference_range">
			    		</div>
			        	<div class="form-group">
