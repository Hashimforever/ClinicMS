    ...
    <div class="col-md-12 main">           
        ...
        <div class="row" style="margin-top: 20px;">
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-success panel-widget" style="border-left: 5px solid #2ecc71;">
                    <div class="row no-padding">
                        <div class="col-sm-3 widget-left" style="color: #2ecc71;">
                            <i class="fas fa-hand-holding-usd fa-3x"></i>
                        </div>
                        <div class="col-sm-9 widget-right">
                            <div class="large">${{ number_format($total['total_amount'], 2) }}</div>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-danger panel-widget" style="border-left: 5px solid #e74c3c;">
                    <div class="row no-padding">
                        <div class="col-sm-3 widget-left" style="color: #e74c3c;">
                            <i class="fas fa-file-invoice-dollar fa-3x"></i>
                        </div>
                        <div class="col-sm-9 widget-right">
                            <div class="large">${{ number_format($total_expense, 2) }}</div>
            ...
            <div class="col-xs-12 col-md-4">
                <div class="panel panel-info panel-widget" style="border-left: 5px solid #3498db;">
                    <div class="row no-padding">
                        <div class="col-sm-3 widget-left" style="color: #3498db;">
                            <i class="fas fa-chart-line fa-3x"></i>
                        </div>
                        <div class="col-sm-9 widget-right">
                            <div class="large" style="color: {{ $profit >= 0 ? '#2ecc71' : '#e74c3c' }}">${{ number_format($profit, 2) }}</div>
                            <div class="text-muted">Net Profit / Loss</div>
                        </div>
                    </div>
                </div>
            </div>
